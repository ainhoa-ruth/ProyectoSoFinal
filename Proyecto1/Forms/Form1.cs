...
namespace Cliente
{
    public partial class Form1 : Form
    {
        ...
        List<Form3> partidas = new List<Form3>();
        ...
        public void crearPartida()
        {
            ...
            Form3 lobby = new Form3(IdPartida, server);
            partidas.Add(lobby);
            lobby.ShowDialog();
        }
        ...
        public void AtenderServidor()
        {
            while (true)
            {
                ...
                switch (codigo)
                {
                    ...
                    case 8:
                        // Al aceptar la partida se le abre el formulario
                    ...
                    case 11:
                        //Envia las jugada
                        IdPartida = Convert.ToInt32(respuesta[2]);
                        partidas[IdPartida].tomaRespuesta2(respuesta);
                        break;
                    case 12:
                        //Envia las jugada2
                        IdPartida = Convert.ToInt32(respuesta[2]);
                        partidas[IdPartida].tomaRespuesta3(respuesta);

                        break;
                    case 13:
                        mensaje = respuesta[1];
                        if (mensaje == "err13") // Error al eliminar un usuario inexistente
                        {
                            A = 0;
        ...
        private void button4_Click(object sender, EventArgs e) 
        {
            ...
            server.Send(msg);
            registrado = true;
            MessageBox.Show(usuario.Text +" te has registrado correctamente.");
        }
        ...
        private void darsedebajabtn_Click(object sender, EventArgs e)
        {
            ...
            IPAddress direc = IPAddress.Parse("147.83.117.22");
                ...
                string mensaje = "13/" + usuario.Text + "/" + password.Text;
        ...
        private void sobrenosotrosbtn_Click(object sender, EventArgs e)
        {
            Form4 f4 = new Form4();
            f4.Show();
        }
